...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="Insides",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC7Insides30AppSettingsTableViewController")
@interface AppSettingsTableViewController : UITableViewController
@property (nonatomic, weak) IBOutlet UITableViewCell * _Null_unspecified sendFeedbackCell;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified darkThemeSwitch;
- (void)viewDidLoad;
...
@property (nonatomic, weak) IBOutlet UITableViewCell * _Null_unspecified resetCell;
@property (nonatomic, weak) IBOutlet UITableViewCell * _Null_unspecified exportCell;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified todayLabel;
@property (nonatomic, weak) IBOutlet UILabel * _Null_unspecified last7DaysLabel;
...
- (IBAction)infoButton:(id _Nonnull)sender;
- (void)onLongPressGestureWithSender:(UILongPressGestureRecognizer * _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC7Insides18InfoViewController")
...
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified confirmPasswordInput;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified appleButton;
@property (nonatomic, weak) IBOutlet UIButton * _Null_unspecified googleButton;
